    ...
    protected void doFilterInternal (HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
            throws ServletException, IOException {
                ...
                try {
                    ...
                    System.out.println("Validated user ID from token: " + userId);
                    if (userId == null){
                        System.out.println("Token validation failed or user ID is null.");
                        filterChain.doFilter(request, response);
                        return;
                    }
                    ...
                    System.out.println("Exception occurred during JWT processing.");
