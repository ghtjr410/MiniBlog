package com.miniblog.back.query.aspect;
...
public class QueryServiceAspect {
    ...
    @Pointcut("execution(* com.miniblog.back.query.service.QueryService.*(..))")
    public void queryServiceMethods() {}

    @AfterReturning("queryServiceMethods()")
    ...
    public Object logServiceExceptions(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        } catch (NotFoundException | DataAccessException ex) {
